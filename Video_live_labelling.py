...
load_clf= load('finalized_model.sav')

Image_HOG_features= np.zeros((1,648),dtype=np.float32())

count = 0
CasFile_face = cv2.CascadeClassifier('G:/IPPR/face_img/Rest_files/Haarcascades/haarcascade_frontalface_alt2.xml')
...
cap = cv2.VideoCapture('G:/IPPR/face_img/Test.mp4')
